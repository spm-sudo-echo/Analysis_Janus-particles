...
um_px = 100/382 #50/255 #for 800x=#  100/382 #for 600x=# 50/314 #for 1000x       # micron to pixel convertion for Hirox microscope 
...
for j in 20:20
if j==1 || j==5
    um_px=100/382  #for 600x  
elseif j==14 || j==15
    um_px =50/255 #for 800x
else
    um_px=50/314 #for 1000x  
end

#Path naming for file storage
filename="VID0$j"   # name of the video to be tracked
pathORIG="C:\\Users\\j.sharma\\OneDrive - Scuola Superiore Sant'Anna\\P10 Microfabrication\\Experiments\\2024\\06.June\\04\\exp2\\"   # path of the folder containing the video to be tracked
