...
pathORIG="C:\\Users\\y.brar\\OneDrive - Scuola Superiore Sant'Anna\\Work\\simulations\\Jyoti\\"   # path of the folder containing the video to be tracked
folderDEST="analysis"   # name of the folder where to store the result of the tracking
pathDEST="C:\\Users\\y.brar\\OneDrive - Scuola Superiore Sant'Anna\\Work\\simulations\\Jyoti\\" *folderDEST   # path of the folder where to store the result of the tracking
